...
par(mfrow = c(2, 3))
plot(beta_sample_chains_list_training[[1]][1:15000],
     ylab = 'Beta Pre-Change Point - Chain 1')
plot(beta_sample_chains_list_training[[2]][1:15000],
     ylab = 'Beta Pre-Change Point - Chain 2')
plot(beta_sample_chains_list_training[[3]][1:15000],
     ylab = 'Beta Pre-Change Point - Chain 3')
plot(beta_star_sample_chains_list_training[[1]][1:15000],
     ylab = 'Beta Post-Change Point - Chain 1')
plot(beta_star_sample_chains_list_training[[2]][1:15000],
     ylab = 'Beta Post-Change Point - Chain 2')
plot(beta_star_sample_chains_list_training[[3]][1:15000],
     ylab = 'Beta Post-Change Point - Chain 3')


for (i in 1:3) {
  print(mean(t0_sample_chains_list_training[[i]]))
}
