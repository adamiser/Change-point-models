...
# Coefficient
par(mfrow = c(2, 3))
plot(beta_sample_chains_list_training[[1]][1:57462],
     ylab = 'Beta Pre-Change Point - Chain 1')
plot(beta_sample_chains_list_training[[2]][1:57462],
     ylab = 'Beta Pre-Change Point - Chain 2')
plot(beta_sample_chains_list_training[[3]][1:57462],
     ylab = 'Beta Pre-Change Point - Chain 3')
plot(beta_star_sample_chains_list_training[[1]][1:57462],
     ylab = 'Beta Post-Change Point - Chain 1')
plot(beta_star_sample_chains_list_training[[2]][1:57462],
     ylab = 'Beta Post-Change Point - Chain 2')
plot(beta_star_sample_chains_list_training[[3]][1:57462],
     ylab = 'Beta Post-Change Point - Chain 3')


plot(plist[[1]][1:19150], type = 'l')
plot(plist[[2]][1:19150], type = 'l')
plot(plist[[3]][1:19150], type = 'l')

# Change point
plot(t0_sample_chains_list_training[[1]][1:19155])

# Likelihood?
plot(pi_vec_sample_chains_list_training[[1]][1:50000])

plot(u_vec_sample_chains_list_training[[1]][1:50000])
